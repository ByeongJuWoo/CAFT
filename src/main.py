...
def main(args):
    ...
    # get loss name for experiments
    
    if args.hieflair_loss != "disabled":
        loss_name = args.hieflair_loss
    elif args.use_flair_loss:
        loss_name = "tcs"
    ...
    if args.caption_sampling_mode == "diverse_sampling":
        sample_name = "ds"
    elif args.caption_sampling_mode == "caft_sampling":
        sample_name = "cs"
    else:
        sample_name = "test"
